...
(function () {
  ...
  function showResults(r) {
    ...
    // the full-screen celebration on the results reveal — same look as the
    // old NEW PB flash, now earned by finishing at 35+ (or beating a PB)
    if (earned || newPB) {
      flashScreen(newPB && earned
        ? 'NEW PB · ' + flashTarget + '+ WPM'
        : newPB ? 'NEW PB' : flashTarget + '+ WPM');
    }
